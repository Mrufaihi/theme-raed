...
| Document                                                                                                               | Purpose                                                                                                                                                                                                                                                                                   |
| ---------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [JAWLINER-TWIG-MIGRATION.md](./JAWLINER-TWIG-MIGRATION.md)                                                           | **MIGRATION (active):** Jawliner(old) static page → Twilight home; hardcoded Twig first, section map, milestone 1 (FAQ), pitfalls |
| [SALLA-THEME-RAED-CONNECT-CONCLUDE-2026-06-19.md](./SALLA-THEME-RAED-CONNECT-CONCLUDE-2026-06-19.md)                   | **START HERE → §15:** browser was the bug (Arc vs Chrome). Local dev works in Chrome, no install needed |
...
| [TWILIGHT-MIGRATION-EXECUTION-PLAN.md](./TWILIGHT-MIGRATION-EXECUTION-PLAN.md)                                         | Generic phased plan (preview → Raed → assets → twilight.json → Twig → JS → QA). **Superseded for Jawliner UI by [JAWLINER-TWIG-MIGRATION.md](./JAWLINER-TWIG-MIGRATION.md)**                                                                                                              |
...
_Last updated: 2026-06-19 — Jawliner migration plan in [JAWLINER-TWIG-MIGRATION.md](./JAWLINER-TWIG-MIGRATION.md); preview workflow in [SALLA-THEME-RAED-CONNECT-CONCLUDE-2026-06-19.md](./SALLA-THEME-RAED-CONNECT-CONCLUDE-2026-06-19.md)._
