...
| Document                                                                                                               | Purpose                                                                                                                                                                                                                                                                                   |
| ---------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [SALLA-THEME-RAED-CONNECT-CONCLUDE-2026-06-19.md](./SALLA-THEME-RAED-CONNECT-CONCLUDE-2026-06-19.md)                   | **Conclude (2026-06-19):** Theme Raed connected; **local preview needs no push** (`assets_url=localhost` + webpack watch); live-update smoke test passed; push = hosted theme only |
...
*Last updated: 2026-06-19 — local preview vs push documented in [SALLA-THEME-RAED-CONNECT-CONCLUDE-2026-06-19.md](./SALLA-THEME-RAED-CONNECT-CONCLUDE-2026-06-19.md).*